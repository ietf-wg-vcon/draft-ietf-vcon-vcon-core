...
The signed form of vCon is defined in [](#signed-form-of-vcon-object) using [JWS] to provide integrity and proof of the conversation data.
The encrypted form of vCon is defined in [](#encrypted-form-of-vcon-object) using [JWE] to provide complete privacy of the conversational data.
...
The mediatype parameter SHOULD be provided for inline analysis files and for externally referenced analysis files when the Content-Type header in the [HTTPS] response is not provided.
A media type may not be defined for the format of the analysis data; in this case the vendor, product and schema parameters SHOULD be used to identify the data format instead.
